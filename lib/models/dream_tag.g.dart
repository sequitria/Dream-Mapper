...
extension DreamTagQueryFilter
  ...
  QueryBuilder<DreamTag, DreamTag, QAfterFilterCondition> descriptionIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DreamTag, DreamTag, QAfterFilterCondition> descriptionEqualTo(
    String? value, {
  ...
  QueryBuilder<DreamTag, DreamTag, QAfterFilterCondition> descriptionLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<DreamTag, DreamTag, QAfterFilterCondition> descriptionBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<DreamTag, DreamTag, QAfterFilterCondition> descriptionStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DreamTag, DreamTag, QAfterFilterCondition> descriptionEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DreamTag, DreamTag, QAfterFilterCondition> descriptionContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DreamTag, DreamTag, QAfterFilterCondition> descriptionMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DreamTag, DreamTag, QAfterFilterCondition> descriptionIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'description',
        value: '',
...
extension DreamTagQuerySortBy on QueryBuilder<DreamTag, DreamTag, QSortBy> {
  QueryBuilder<DreamTag, DreamTag, QAfterSortBy> sortByDescription() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.asc);
    });
  }

  QueryBuilder<DreamTag, DreamTag, QAfterSortBy> sortByDescriptionDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension DreamTagQuerySortThenBy
  ...
  QueryBuilder<DreamTag, DreamTag, QAfterSortBy> thenByDescription() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.asc);
    });
  }

  QueryBuilder<DreamTag, DreamTag, QAfterSortBy> thenByDescriptionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.desc);
    });
  }
...
extension DreamTagQueryWhereDistinct
  ...
  QueryBuilder<DreamTag, DreamTag, QDistinct> distinctByDescription(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension DreamTagQueryProperty
  ...
  QueryBuilder<DreamTag, String?, QQueryOperations> descriptionProperty() {
    return QueryBuilder.apply(this, (query) {
